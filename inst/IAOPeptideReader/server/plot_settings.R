    ...
    plot_settings_input_mapping <- reactive({
        ...
        mapping <- list(
            ...
            list("input_id" = "plot_settings_title_color",
                 ...
                 "label" = "Title color",
                 "value" = "#000000",
                 "onchange" = "iaopr.title_color = this.value;",
                 "width" = width),
            ...
            list("input_id" = "plot_settings_lambda_values_bg",
                 ...
                 "value" = "#FFFFFF",
                 "onchange" = "iaopr.lambda_values_bg = this.value;",
                 "width" = width),
            ...
            list("input_id" = "plot_settings_axes_color",
                 ...
                 "label" = "Axes color",
                 "value" = "#000000",
                 "onchange" = "iaopr.axes_color = this.value;",
                 "width" = width),
            list("input_id" = "plot_settings_axes_labels_color",
                 "input_type" = "color",
                 "label" = "Axes labels color",
                 "value" = "#000000",
                 "onchange" = "iaopr.axes_labels_color = this.value;",
                 "width" = width),
            ...
            list("input_id" = "plot_background_color",
                 ...
                 "value" = "#FFFFFF",
                 "onchange" = "iaopr.background_color = this.value;",
                 "width" = width)
        )
